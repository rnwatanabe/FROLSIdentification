%% his function performs the identification of a NARMAX model that represents the dynamic of the system  with signal1 as input and signal2 as output. It
%is used after the identification of a NARX model and of the residue of the NARX model. Only after this step, the coefficients of the model
...
function [a, an, xi] = NARMAXCompleteIdentification(signal1, signal2, Da, Dn, dataLength, divisions,  delta, degree, degree_n)
